...
class Network(object):
	...
	def decoder(self, x, reuse=False):
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_1', reuse=reuse)
		x = tf.layers.dense(x, 512, activation=tf.nn.leaky_relu, reuse=reuse, name='decoder_dense2')
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_2', reuse=reuse)
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_3', reuse=reuse)
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_4', reuse=reuse)
		print(x.get_shape())
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_5', reuse=reuse)
		print(x.get_shape())
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_6', reuse=reuse)
		print(x.get_shape())
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_7', reuse=reuse)
		print(x.get_shape())
		...
		x = tf.layers.batch_normalization(x, name='decoder_batch_norm_8', reuse=reuse)
